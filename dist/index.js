...
var _FluidScroll = __webpack_require__(6);

var _FluidScroll2 = _interopRequireDefault(_FluidScroll);
...
var ReactFluidScroll = function (_Component) {
  _inherits(ReactFluidScroll, _Component);

  function ReactFluidScroll() {
    _classCallCheck(this, ReactFluidScroll);

    return _possibleConstructorReturn(this, (ReactFluidScroll.__proto__ || Object.getPrototypeOf(ReactFluidScroll)).apply(this, arguments));
  }

  _createClass(ReactFluidScroll, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _props = this.props,
          viscosity = _props.viscosity,
          scrollHook = _props.scrollHook;

      this.fluidScroll = new _FluidScroll2.default({
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'fluid-scroll-viewport', style: viewportStyle },
          _react2.default.createElement(
            'div',
            { id: 'fluid-scroll-content', style: contentStyle },
            children
          )
        ),
        _react2.default.createElement('div', { id: 'body-spacer', style: bodySpacer })
      );
    }
  }]);

  return ReactFluidScroll;
}(_react.Component);

ReactFluidScroll.propTypes = {
  children: _propTypes2.default.oneOfType([_propTypes2.default.arrayOf(_propTypes2.default.node), _propTypes2.default.node]).isRequired,
  scrollHook: _propTypes2.default.func,
  viscosity: _propTypes2.default.number
};
...
exports.default = ReactFluidScroll;
...
var FluidScroll = function () {
  function FluidScroll() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, FluidScroll);
  ...
  _createClass(FluidScroll, [{
    ...
    value: function updateLoop() {
      ...
      if (this.scrollRequested > 0) {
        // if more than one scroll event has fired
        this.currentRequest = requestAnimationFrame(this.updateLoop);
      } else {
    ...
    key: 'updateFromResize',
    value: function updateFromResize() {
...
var _ReactFluidScroll = __webpack_require__(5);

var _ReactFluidScroll2 = _interopRequireDefault(_ReactFluidScroll);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _ReactFluidScroll2.default;
